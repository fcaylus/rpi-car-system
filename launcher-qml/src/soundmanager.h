...
class SoundManager: public QObject
{
    ...
    public:
        ...
        std::thread checkForNewMusicFilesThread()
        {
            return std::thread([this] {checkForNewMusicFiles();});
        }
    ...
    private:
        ...
        QString _artistMapFilePath;
        QString _albumMapFilePath;
        QString _trackListFilePath;

        QStringList _musicFileFormats;

        std::mutex _mediaListReadyMutex;
